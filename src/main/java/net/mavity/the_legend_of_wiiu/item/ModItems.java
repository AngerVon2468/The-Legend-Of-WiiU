...
import static net.mavity.the_legend_of_wiiu.propertymanager.PropertyInit.RUPEETYPE;
...
public class ModItems {
    ...
    public static final DeferredItem<Item> THE_MASTER_SWORD = ITEMS.register("the_master_sword",
            () -> new SwordItem(Tiers.DIAMOND, 8, -2.4f,
                    new Item.Properties().durability(552)));

    public static final DeferredItem<Item> THE_AWAKENED_MASTER_SWORD = ITEMS.register("the_awakened_master_sword",
    ...
    public static final DeferredItem<Item> MAJORAS_MASK = ITEMS.register("majoras_mask",
            () -> new Item(new Item.Properties().stacksTo(1).durability(0)));
